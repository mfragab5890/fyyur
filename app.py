...
def show_venue(venue_id):
    ...
    all_shows = db.session.query(Show).join(Venue).filter(Show.venue_id == venue_id).all()
    ...
    data = {
        'id': all_shows[0].ven_show.id,
        'name': all_shows[0].ven_show.name,
        'city': all_shows[0].ven_show.city,
        'state': all_shows[0].ven_show.state,
        'phone': all_shows[0].ven_show.phone,
        'genres': all_shows[0].ven_show.genre.split(','),
        'image_link': all_shows[0].ven_show.image_link,
        'facebook_link': all_shows[0].ven_show.facebook_link,
        'seeking_talent': all_shows[0].ven_show.seeking_talent,
        'seeking_description': all_shows[0].ven_show.seeking_description,
...
def show_artist(artist_id):
    ...
    past_shows_count = 0
    upcoming_shows_count = 0
    all_shows = db.session.query(Show).join(Artist).filter(Show.artist_id == artist_id).all()
    for show in all_shows:
        if show.start_time < datetime.now():
            past_shows_count += 1
            past_show = {
    ...
    data = {
        'id': all_shows[0].art_show.id,
        'name': all_shows[0].art_show.name,
        'city': all_shows[0].art_show.city,
        'state': all_shows[0].art_show.state,
        'phone': all_shows[0].art_show.phone,
        'genres': all_shows[0].art_show.genres.split(','),
        'image_link': all_shows[0].art_show.image_link,
        'facebook_link': all_shows[0].art_show.facebook_link,
        'seeking_venue': all_shows[0].art_show.seeking_venue,
        'seeking_description': all_shows[0].art_show.seeking_description,
        'past_shows': past_shows.copy(),
        'upcoming_shows': upcoming_shows.copy(),
        'past_shows_count': past_shows_count,
        'upcoming_shows_count': upcoming_shows_count
