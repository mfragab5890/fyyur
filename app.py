...
# add column to db table venue
Venue.seeking_talent = db.Column(db.Boolean, nullable=False, default=False)
Venue.seeking_description = db.Column(db.String(), nullable=False)
